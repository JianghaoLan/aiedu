...
public class CourseController extends BaseController
{
     ...
     * 查询课程列表
     */
    @RequiresPermissions("aiedu:course:list")
    @GetMapping("/list")
     ...
     * 导出课程列表
     */
    @RequiresPermissions("aiedu:course:export")
     ...
     * 获取课程详细信息
     */
    @RequiresPermissions("aiedu:course:query")
     ...
     * 新增课程
     */
    @RequiresPermissions("aiedu:course:add")
     ...
     * 修改课程
     */
    @RequiresPermissions("aiedu:course:edit")
     ...
     * 删除课程
     */
    @RequiresPermissions("aiedu:course:remove")
